...
class PeterNorvigTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.invalid_test_game = \
            '333380000000700005100000000000000360002004000070000000000060130045200000000000800'
        ...
        self.invalid_test_game_length = \
            '333380000000700005100000000000000360002004000070000000000060130045200000000000800123'
        self.invalid_input_data = \
            '!@#!@#$%^&*(700005100000000000000360002004000070000000000060130045200000000000800'
        self.peter_norving_test = PeterNorvig()
        self.expected_length = 81

    def test_a_valid_sudoku_game_is_solved_correctly(self):
        self.assertEqual(self.peter_norving_test.solve(self.valid_test_game),
                         self.valid_test_game_solved)
    ...
    def test_all_possible_values_are_generated_for_a_square(self):
        test_game_key = 'D9'
        test_game_values = \
            self.peter_norving_test.parse_grid(self.valid_test_game)
        expected_possible_values = '124789'
        self.assertEqual(test_game_values.get(test_game_key),
                         expected_possible_values)

    def test_values_are_not_generated_for_invalid_sudoku_game(self):
        test_game_values = \
            self.peter_norving_test.parse_grid(self.invalid_test_game)
