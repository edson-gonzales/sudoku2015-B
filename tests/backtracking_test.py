...
class BacktrackingTest(unittest.TestCase):
	...
	def test_return_true_when_a_number_is_used_in_a_row(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,6,8],[4,8,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,3,1,9]]
		backtracking = Backtracking(grid)
	...
	def test_return_false_when_a_number_is_not_used_in_a_row(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,0,0],[4,8,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,3,1,9]]
		backtracking = Backtracking(grid)
		self.assertFalse(backtracking.used_in_row(grid,1,8))
	def test_return_false_when_a_number_is_not_used_in_the_last_row(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,6,8],[4,8,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,0,0,9]]
		backtracking = Backtracking(grid)
	...
	def test_return_true_when_a_number_is_used_in_the_last_col(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,6,0],[4,8,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,0],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,3,1,9]]
		backtracking = Backtracking(grid)
		self.assertTrue(backtracking.used_in_col(grid,8,3))
	def test_return_false_when_a_number_is_not_used_in_a_col(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,0,0],[4,0,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,3,1,9]]
		backtracking = Backtracking(grid)
		self.assertFalse(backtracking.used_in_col(grid,1,8))
	def test_return_false_when_a_number_is_not_used_in_the_last_col(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,6,8],[4,8,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,0],[1,3,8,9,4,7,2,5,0],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,0,0,9]]
		backtracking = Backtracking(grid)
	...
	def test_return_false_when_a_number_is_not_used_in_a_box(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,0,0],[4,0,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,0,6,3,1,9]]
		backtracking = Backtracking(grid)
	...
	def test_return_true_when_a_number_is_valid_in_a_sudoku_grid_position(self):
		grid = [[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,6,8],[4,8,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,0,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,3,1,9]]
		backtracking = Backtracking(grid)
	...
	def test_return_grid_solved_when_is_solved_a_valid_sudoku_grid(self):
		...
		backtracking = Backtracking(grid)
		self.assertEqual([[3,1,6,5,7,8,4,9,2],[5,2,9,1,3,4,7,6,8],[4,8,7,6,2,9,5,3,1],[2,6,3,4,1,5,9,8,7],[9,7,4,8,6,3,1,2,5],[8,5,1,7,9,2,6,4,3],[1,3,8,9,4,7,2,5,6],[6,9,2,3,5,1,8,7,4],[7,4,5,2,8,6,3,1,9]],backtracking.solve(grid))
	def test_return_None_when_cannot_be_solved_a_sudoku_grid(self):
		grid = [[3,0,6,5,0,8,4,0,0],[5,2,0,0,0,0,0,0,0],[0,8,7,0,0,0,0,3,1],[0,0,3,0,1,0,0,8,0],[9,0,0,8,6,3,0,0,5],[0,5,0,0,9,0,6,0,0],[1,3,0,0,0,0,2,5,0],[0,0,0,0,0,0,0,7,4],[0,0,5,2,0,6,3,9,2]]
		backtracking = Backtracking(grid)
		self.assertFalse(backtracking.solve(grid))
